document.addEventListener('DOMContentLoaded', () => {
  ...
  // 고유 Session ID 관리 (n8n '입력 정리' 노드 필수 파라미터)
  ...
  // JOY AI 실시간 응답 카드 (n8n에서 수신한 reply 적용)
  function appendJOYResponse(replyText) {
    // marked.js가 로드되어 있으면 마크다운을 HTML로 변환, 아니면 기존 이스케이프 처리
    const formattedReply = typeof marked !== 'undefined' 
    ...
    <div class="flex flex-col items-start my-4">
      <div class="w-full max-w-[850px] bg-white rounded-3xl p-8 border border-gray-200 shadow-sm text-gray-800 space-y-6">
        ...
        <div class="text-sm leading-relaxed text-gray-700 markdown-body">
          ${formattedReply}
        </div>
      </div>
    </div>
